...
export const BEACON_FIXTURE_EXPORT = [
  { ...base, sequence: 1, event: { id: "fixture-claude-prompt", kind: "agent_runtime", category: "prompt", action: "prompt.submitted", fidelity: "observed" },
  ...
  { ...base, sequence: 2, event: { id: "fixture-codex-tool", kind: "agent_runtime", category: "tool", action: "tool.invoked", fidelity: "observed" },
  ...
  { ...base, sequence: 3, event: { id: "fixture-codex-result", kind: "agent_runtime", category: "command", action: "command.executed", fidelity: "observed" },
  ...
  { ...base, sequence: 4, event: { id: "fixture-codex-status", kind: "agent_runtime", category: "session", action: "session.status", fidelity: "observed" },
    harness: { name: "codex", collection_method: "poll" }, session: { id: "codex-fixture" },
