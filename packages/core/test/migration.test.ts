...
import { applyEventPurgeIntegrityV22, applyEventPurgeSelectorKindV24, applyEventPurgeSelectorKindV26, applyEventPurgeSelectorKindV27, applyEventPurgeSelectorKindV28 } from "../src/ledger/purge-schema";
import {
...
describe("openLedger migrations", () => {
  ...
  test("v28 widens selector_kind to source without rewriting proofs", () => {
    const db = new Database(":memory:");
    db.exec(`
      CREATE TABLE event_purges (
        receipt_id TEXT PRIMARY KEY,
