...
describe("public surface", () => {
  test("re-exports every runtime value the contract layer defines", () => {
    expect(Object.keys(core).sort()).toEqual([
      ...
      "inspectCheckpoints",
      "inspectConnectionDisconnect",
      "inspectConnections",
      "inspectDoctrineFiles",
      "inspectLedgerHealth",
      "inspectOwnerCorrectionPageCount",
      "inspectOwnerPageCorrectionTargets",
      "inspectPageIndex",
      "inspectPurgeHealth",
      "inspectServeDoctor",
      "inspectSourceGrant",
      ...
      "normalizeSourceModelEndpoint",
      "normalizeSourceModelName",
      "objectFromStatement",
      "openOwnedDirectory",
