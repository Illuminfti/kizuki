...
describe("canon write capability", () => {
  ...
  test("the public core surface exports applyCanonWrite and not writePage", () => {
    ...
    expect(Object.keys(core)).not.toContain("search");
    expect(Object.keys(core)).not.toContain("searchResult");
    ...
    expect(Object.keys(core)).not.toContain("findPageById");
    expect(Object.keys(core)).not.toContain("rebuildSearch");
    expect(Object.keys(core)).not.toContain("rebuildGraph");
    expect(Object.keys(core)).not.toContain("refreshDerivedPage");
    expect(Object.keys(core)).not.toContain("removeDerivedPage");
    expect(Object.keys(core)).not.toContain("indexEvent");
    expect(Object.keys(core)).not.toContain("indexPage");
    expect(Object.keys(core)).not.toContain("removeDoc");
    expect(Object.keys(core)).not.toContain("removeCanonPath");
