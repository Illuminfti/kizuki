...
export interface FileCase {
  format: FileFormat; connector: string; sentinel: string; source: string; events: number; proposals: number;
...
export function fileImportFixtures(referenceDay: string): FileCase[] {
  ...
  return [
    { format: "ics", connector: "kizuki.ics", sentinel: "calendarlark", source: "calendar.ics", events: 1, proposals: 2,
      ...
      invalid: { "calendar.ics": "BEGIN:VEVENT\r\nSUMMARY:Synthetic invalid calendar\r\nEND:VEVENT\r\n" }, invalid_mode: "failed_run", invalid_events: 0, invalid_error: "VCALENDAR" },
    { format: "markdown-folder", connector: "kizuki.markdown-folder", sentinel: "markdownotter", source: "notes", events: 1, proposals: 2,
    ...
    { format: "chatgpt", connector: "kizuki.import-chatgpt", sentinel: "chatgptbadger", source: "conversations.json", events: 1, proposals: 2,
      valid: { "conversations.json": JSON.stringify([chatgpt("synthetic-chatgpt", sentence("chatgptbadger"))]) },
      invalid: { "conversations.json": JSON.stringify([chatgpt("synthetic-partial-chatgpt", sentence("chatgptbadger")), "synthetic malformed record"]) }, invalid_mode: "partial", invalid_events: 1, proposals: 2, invalid_error: "not_object" },
    { format: "claude", connector: "kizuki.import-claude", sentinel: "claudekingfisher", source: "conversations.json", events: 1, proposals: 2,
      valid: { "conversations.json": JSON.stringify([claude("synthetic-claude", sentence("claudekingfisher"))]) },
      invalid: { "conversations.json": JSON.stringify([claude("synthetic-partial-claude", sentence("claudekingfisher")), "synthetic malformed record"]) }, invalid_mode: "partial", invalid_events: 1, proposals: 2, invalid_error: "not_object" },
    { format: "x-archive", connector: "kizuki.import-x-archive", sentinel: "xylophoneriver", source: "archive", events: 1, proposals: 2,
    ...
    { format: "whatsapp", connector: "kizuki.import-whatsapp", sentinel: "whatsappwren", source: "chat.txt", events: 1, proposals: 3,
      valid: { "chat.txt": `1/13/26, 9:15 AM - Ada: ${sentence("whatsappwren")}\n` }, invalid: { "chat.txt": "Synthetic text without a timestamp or sender.\n" }, invalid_mode: "failed_run", invalid_events: 0, invalid_error: "timestamp" },
    { format: "pocket", connector: "kizuki.import-pocket", sentinel: "pocketpuffin", source: "part_000000.csv", events: 1, proposals: 2,
      ...
      invalid: { "part_000000.csv": 'title,url,time_added\n"unterminated,https://example.test/synthetic,1767225600\n' }, invalid_mode: "failed_run", invalid_events: 0, invalid_error: "quote" },
    { format: "omnivore", connector: "kizuki.import-omnivore", sentinel: "omnivoretern", source: "export", events: 1, proposals: 2,
