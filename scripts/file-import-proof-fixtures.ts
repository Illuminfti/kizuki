...
export interface FileCase {
  format: FileFormat; connector: string; sentinel: string; source: string; events: number; proposals: number; repeat_duplicates: number; last_batch_stored: number;
...
export function fileImportFixtures(referenceDay: string): FileCase[] {
  ...
  return [
    { format: "ics", connector: "kizuki.ics", sentinel: "calendarlark", source: "calendar.ics", events: 1, proposals: 2, repeat_duplicates: 1, last_batch_stored: 1,
    ...
    { format: "markdown-folder", connector: "kizuki.markdown-folder", sentinel: "markdownotter", source: "notes", events: 1, proposals: 2, repeat_duplicates: 0, last_batch_stored: 1,
    ...
    { format: "claude", connector: "kizuki.import-claude", sentinel: "claudekingfisher", source: "conversations.json", events: 1, proposals: 2, repeat_duplicates: 0, last_batch_stored: 1,
    ...
    { format: "x-archive", connector: "kizuki.import-x-archive", sentinel: "xylophoneriver", source: "archive", events: 1, proposals: 2, repeat_duplicates: 0, last_batch_stored: 0,
    ...
    { format: "whatsapp", connector: "kizuki.import-whatsapp", sentinel: "whatsappwren", source: "chat.txt", events: 1, proposals: 3, repeat_duplicates: 1, last_batch_stored: 1,
    ...
    { format: "pocket", connector: "kizuki.import-pocket", sentinel: "pocketpuffin", source: "part_000000.csv", events: 1, proposals: 2, repeat_duplicates: 1, last_batch_stored: 1,
    ...
    { format: "omnivore", connector: "kizuki.import-omnivore", sentinel: "omnivoretern", source: "export", events: 1, proposals: 2, repeat_duplicates: 1, last_batch_stored: 1,
