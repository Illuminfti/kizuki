...
import { checkProof, parseProofTokens } from "./doc-proofs";
import type { DocsContext, ProofToken } from "./doc-proofs";

export { checkProof, parseProofTokens };
export type { DocsContext, ProofToken };
