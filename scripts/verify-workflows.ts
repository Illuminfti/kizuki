...
const NATIVE_CONSUMER_TESTS = "bun test packages/core/test/ledger-wal.test.ts packages/core/test/canon/canon-files.test.ts packages/core/test/canon/receipt-stream.test.ts packages/core/test/canon/apply.test.ts packages/core/test/vault/mutation-scope.test.ts packages/core/test/vault/mutation-callers.test.ts packages/core/test/agents/credential-file.test.ts packages/core/test/agents/app-enrollment.test.ts packages/core/test/agents/enrollment-flow.test.ts packages/core/test/agents/enrollment-preview.test.ts packages/core/test/agents/enrollment-fault.test.ts packages/core/test/correction/correct.test.ts packages/core/test/correction/source-consent.test.ts packages/core/test/serve/stop-control.test.ts packages/cli/test/serve-stop.test.ts packages/core/test/serve/model-settings.test.ts packages/core/test/serve/model-diagnostics.test.ts packages/core/test/serve/app-http.test.ts packages/cli/test/app-host.test.ts packages/cli/test/app-agents.test.ts packages/cli/test/app-client.test.ts packages/cli/test/app-service.test.ts packages/cli/test/app-browser.test.ts packages/cli/test/app-model-settings.test.ts packages/cli/test/app-model-journey.test.ts packages/cli/test/app-privacy-races.test.ts packages/mcp/test/credential-stdio.test.ts";
