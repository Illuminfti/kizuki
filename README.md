...
The richer world-model architecture above is the direction being built on top of those foundations. **No roadmap concept becomes a public feature until its implementation and acceptance proof exist.** Owner decision D21 (2026-09-17): 1.0 is that world-model journey, not capture-to-context. Closed GitHub packets and RFC fixtures are not shipped surfaces.
