...
served to any agent from any harness — Hermes, Claude Code, codex, anything —
...
Planned 2026-09-01 by Fable with Illumi across four grilling rounds (decision
...
machine, and Illumi's estate LifeOS is retired with Kizuki running his life.**
...
## Decision log (all settled with Illumi, 2026-09-01)

| #   | Decision          | Answer                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| --- | ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Frame             | Public OSS product; Illumi is user #1                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 2   | Scope             | Memory substrate + proactive rails. **Not a harness, hosts no agents** (Illumi's mid-plan correction, supersedes the earlier full-OS answer): pairs with any harness — Hermes, Claude Code, codex, Grok bots — via CLI + MCP                                                                                                                                                                                                                                                      |
| 3   | Repo              | Fresh `Illuminfti/kizuki`, clean history; salvage from lifeos-oss spine by copy only                                                                                                                                                                                                                                                                                                                                                                                              |
...
| 8   | Name              | **Kizuki** — binary `kizuki`, repo `Illuminfti/kizuki`; npm + PyPI `kizuki` free (checked 2026-09-01), claim on plan approval                                                                                                                                                                                                                                                                                                                                                     |
...
| 11  | Hermes            | Separate forever; consumes Kizuki via MCP like every other harness. Estate migration = memory layers, not the persona stack                                                                                                                                                                                                                                                                                                                                                       |
...
| 13  | 1.0 bar           | Stranger loop AND Illumi cutover, both                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
- **Fable** — architect + review bar. Owns this plan, the GPT Pro brief and
  arbitration, TUI/taste work hands-on, PR review before Illumi. May merge
...
1. Claim `kizuki` on npm + PyPI (honest placeholder) and create
   `Illuminfti/kizuki` (needs registry account tokens on the box — flagged).
