...
| [GBrain](https://github.com/garrytan/gbrain) | Reference for Postgres-native personal knowledge, hybrid retrieval, and personal-brain workflows | MIT, copyright 2026 Garry Tan; retain the copyright and permission notice for copied or substantial portions | Reference and integration candidate only; no Kizuki dependency, fork, or copied code is claimed | Evaluated at package 0.9.1, commit `aeb477d39b730ffc61c4435bc686c47618cd8e46`, on 2026-09-01 | It is a useful public comparison point for retrieval and personal knowledge workflows that Kizuki should evaluate honestly |
