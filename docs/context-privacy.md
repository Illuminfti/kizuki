...
labels, taint or authority stamps, retracted claims, and missing, unlabelled or
...
Object strings are JSON-escaped so embedded newlines cannot manufacture new
...
Validity gaps require the complete bounded history to be readable: removing a
...
Candidate scans remain bounded. The working-claim and alias scans consider at
most 400 candidates before applying their smaller output limits. Packets are
briefs, not exhaustive exports.
