...
| `oracle-backlog` | ship backlog cron (Work Pro OFF; Neuronist seat lock; owner TAP YES 2026-09-15) | Read issue #597 first; compose `issue-pickup-execution` and `handoff-work` |
